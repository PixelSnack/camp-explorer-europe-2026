...
This document tracks all Featured camp listings, including verification status, activation dates, and renewal information. Featured listings receive enhanced visibility through:
- "Featured Camp" badge on card
- Priority placement in category (appears first)
...
**Verified By:** camp-data-verifier + camp-content-researcher agents
**Verification Status:** COMPLETE - All data verified from official sources
...
- **38 Years Experience** (Est. 1987)
- **European Travel Awards 2024** - Best Summer & Winter Camp Switzerland
- **75+ Nationalities** represented
- **10,000+ Annual Campers**
- **45+ Activities** offered
- **5 Languages** taught (incl. Mandarin)
- **1:2 Staff Ratio** (all staff included)
- **Only Year-Round Camp** in Switzerland (10 months/year)

#### Sources Used for Verification
1. Les Elfes Official Website (leselfes.com) - PRIMARY
2. Verbier Tourism Office
3. European Travel Awards
4. World-Camps.org
5. Premium Switzerland
6. Smapse.com
...
| Camp Suisse (summer, ID 3) and Camp Suisse Ski Camp (winter, ID 84), Les Crosets | Jodie Parker-Hully, Business Operations Manager, jodie@campsuisse.com | Sep 15, 2026 | 🟡 Wrote 16 Sept "We would be really keen to go ahead with the premium feature", asked whether two cards means paying twice (answer: no, one Premium covers both), sent billing details | **Invoice 2026-3 created in Revolut 16 Sept (Open, NOT sent by Revolut; EUR 199 summer line plus a EUR 0 ski camp line "included")**, International Camp Suisse Ltd, 3365 The Pentagon, Century Way, Thorpe Park, Leeds LS15 8ZB, UK, VAT GB142619422. Reply draft with the PDF to attach sits in her thread. Both cards updated as standard listings the same night (commit 97b0225); **Premium styling waits for her confirmation** (owner decision 16 Sept: not before she has fully committed). Still to come from her: photographs, approval of six highlights per card; video links already supplied (summer film ID garbled in the email encoding, re-read before use; ski film youtube GvYDt8DlCRY) |
...
## Featured Listing Checklist

Before activating any Featured listing:

### Verification Requirements
- [ ] Price verified from official website (per-child, not facility rate)
- [ ] Booking URL tested and functional
- [ ] Age ranges confirmed
- [ ] Activities verified
- [ ] Contact information current
- [ ] Passes 5-point camp verification criteria
- [ ] No red flags or complaints found

### Technical Requirements
- [ ] `featured: true` property added to camp object
- [ ] Featured badge displays correctly
- [ ] Priority placement working in category
- [ ] Highlighted card styling applied
- [ ] Mobile display tested
- [ ] Desktop display tested

### Documentation Requirements
- [ ] Entry added to this document
- [ ] Verification sources documented
- [ ] Payment received (if paid listing)
