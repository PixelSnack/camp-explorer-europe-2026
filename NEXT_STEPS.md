...
**Deadline met:** winter section live since 14 Sept as promised to Les Elfes.
**Sales:** ILC (2026-001, PDF, due 17 Sept), Les Elfes (Revolut 2026-2, sent 16 Sept, due 30 Sept), Camp Suisse (Revolut 2026-3, sent 16 Sept, due 30 Sept). EUR 199 each, none paid yet.
...
## 🔴 **SESSION END 16 September 2026, 23:40. START HERE.**

**State.** All work committed; the owner pushes via GitHub Desktop (check `git rev-list --count origin/main..HEAD`). No code changed after 97b0225 (Camp Suisse cards, pushed). Build and validators were green at that commit.

**Money in, all EUR 199, none paid yet:** ILC invoice 2026-001 (PDF, due 17 Sept; payment check 18 Sept, a reminder draft only after the due date), Les Elfes Revolut 2026-2 (sent by the owner 16 Sept to Alexandra and separately to compta@, due 30 Sept), Camp Suisse Revolut 2026-3 (sent 16 Sept, due 30 Sept). Next Revolut number 2026-4. Each Revolut invoice carries its own payment link.

**Mail sent tonight by the owner, all from partnerships@:** Camp Suisse Premium answer with invoice; Jordan Harps (Summer Discovery / Atlas) reply, third version; Les Elfes invoice resend to Alexandra and to compta@; the Auersperg message through their contact form (their office@ address bounces on a forwarding policy); and seven template-of-record outreach mails between 23:25 and 23:33: CERAN, Sirdal Huskyfarm, Zeilschool De Kikkert, Summer Camps Holland, Wild Camp, Bede's Summer School, Humboldt-Institut.

**Outreach drafts still waiting (as of 23:35):** 21 English first-contact drafts (subject "...a question about 2027") plus 4 new Danish ones (SceneKunst, Din Camp, Nordisk Sommerlejr for børn, Ranum Efterskole; created from sorenthoning@, owner switches From to partnerships@ and closes the space twice per mail). The English SceneKunst draft and everything titled [SUPERSEDED, DISCARD] are for the owner to delete. Owner rules set tonight: Danish operators in fluent Danish; prices stay EUR; Norway and Sweden stay English.

**Waiting on replies:** Camp Suisse (Jodie) confirmation, then Premium styling on IDs 3 and 84 (six highlights each, video buttons: ski GvYDt8DlCRY; summer ID was garbled by encoding in her mail, probably 0CxscmPNlKo, verify before use; her photographs). Jordan Harps. Auersperg. Replies to the outreach mails of 15 and 16 Sept.

**Owner to-dos, none urgent:** deactivate the unshared standalone Revolut payment link "Invoice 2026-002"; get the Revolut 2026 account statement (April to July plan fees; Chrome blocked the download); read the DKK amounts of the 6 and 10 Sept OpenAI payments from the private card statement for the expense list in "ResourceHub receipts 2026".

**Next work, in order:** (a) Wave 2 re-verification, Nordics first, still the critical path; (b) ID 5 Atlas corrections (16 to 17 year-olds half board, Plus Heathrow transfer 8 AM to 3 PM only, legal operator Summer Discovery Europe Limited); (c) Cloudflare "managing AI crawlers" check on the europeansummercamps.com zone; (d) batch 1a on 22 Sept (trailingSlash plus 404 first). Open for the owner, not to be edited without him: FEATURED_LISTINGS_POLICY still records a cap of three Premium per category, which contradicts his "we simply expand". Playground holds the PMV foreign-services VAT question (bridge note, updated with 2026-2).

**Rules learned tonight (LESSONS_LEARNED 16 Sept, memory):** never touch a draft the owner is writing; a failed tool call is recorded as failed; one wrong URL is not a check; Danish operators in Danish.

---

## **SESSION 16 September 2026, evening (detail; the block above is the current state).**
...
- **Summer Discovery lead** (Jordan Harps, jharps@summerdiscovery.com, contact form 16 Sept 15:05: "Looking forward to connecting regarding Summer Discovery and Atlas Summer Courses!"). Research (agent, key claims re-read by the lead): Summer Discovery owns Atlas Summer Courses (formerly Oxford Summer Courses; Companies House chain Summer Discovery Europe Ltd 08011543 to Bridgemark Education 12423697 to Summer Discovery UK Ltd since 29 Oct 2024); Atlas runs residential programmes at Oxford and Cambridge colleges (hired) and at Harrow School for ages 9 to 14 (hired, "not affiliated"); Madrid unconfirmed; Jordan's title NOT FOUND. GA4: 22 booking clicks to ID 5 since March. **Reply drafted and rewritten the same evening on the owner's review** (new thread, subject "European Summer Camps: Summer Discovery and Atlas Summer Courses"): thanks him for reaching out and for thinking of both brands, names the Oxford listing and its 22 referrals, connects to our 7 Sept form message to Atlas, recaps the terms (2026 free, EUR 79 standard, Premium EUR 199 first year covering up to three cards), says we list European programmes only, and asks what he has in mind. **No call offer** (owner: only if he asks). The first version, with a call offer, is retitled SUPERSEDED. **Jordan's title: NOT FOUND** after LinkedIn people search, the Summer Discovery and Atlas company member searches (no Harps at either), the guessed profile URL (404), the Summer Discovery leadership page (VP Partnerships is Sam Berey) and a web search. Size facts, for context only: Summer Discovery calls itself "the largest provider of pre-college, enrichment, and gifted summer programs", founded 1966, "over 300 courses at 15+ campuses", Verlinvest-backed; LinkedIn shows 11 to 50 office employees for Summer Discovery and for Atlas. No special deal proposed: the existing terms cover three Atlas cards.
- **Revolut "Expense info required"** on the OpenAI and Anthropic card payments of 13 Sept: the panel asks for a receipt upload, a description, an accounting category and a tax rate, then Submit. Revolut's Expenses page states a member becomes active (DKK 60 a month) on the first submitted expense. Nothing submitted; owner decides whether to leave the labels or ask Revolut support if a receipt can be attached without activating the module.
...
**Update 16 Sept, late:** the owner SENT the Camp Suisse reply (invoice 2026-3 attached) and the Jordan Harps reply (third version). He confirmed in Sent that the Les Elfes invoice was NOT attached on 10 Sept; a short apology with invoice 2026-002 is drafted in Alexandra's thread (cc compta@), PDF to attach from Downloads, 'Invoice 2026-002 Les Elfes International.pdf'. The Revolut 2026 account statement did not download and did not arrive by email; retry later.

**Auersperg (ID for Auersperg-International Summer Camp): the 14 Sept outreach bounced.** Their Microsoft 365 tenant returned it three minutes after sending with 550 5.7.520 "Your organization does not allow external forwarding": office@auersperg-summercamp.at forwards to an outside address and their own policy blocks it, so the person who reads that mail almost certainly never saw it. The bounce landed in the owner's Gmail, not one of the five addresses, which is why the evening searches missed it. The site lists no other address. **On the owner's explicit go, the template-of-record message (with a paragraph telling them about the forwarding failure, 21 referrals re-read in GA4 on 16 Sept, no "early 2025" claim) was submitted through auersperg-summercamp.at/contact at about 23:15 on 16 Sept, name "Søren Thoning, European Summer Camps", reply address partnerships@; the site confirmed "Die Nachricht wurde erfolgreich übermittelt".** Phone fallback: +43 676 51 33 442.

**Les Elfes invoice, owner question 16 Sept:** the PDF was chosen only because the 12 Sept rule said the two partners already holding a PDF get no second invoice, and that premise failed (never received). Plan: issue it in Revolut as **2026-2** (the unused Revolut number, the same sequence slot as the undelivered PDF 2026-002, which becomes a superseded draft of that number), summer line EUR 199 plus winter line EUR 0 included, service period 2027, due 14 days from issue; then replace the Alexandra draft (no number named, pay-online section mentioned) and the owner attaches the Revolut PDF. **DONE 16 Sept, late:** Revolut invoice **2026-2** created (Open, never sent by Revolut; customer Les Elfes International S.A., Alexandra Stettler, compta@leselfes.com, Rue du Centre sportif 20, 1936 Verbier; summer line EUR 199 service period 2027, winter line EUR 0 included; due 30 Sept). Its own checkout payment link verified distinct from 2026-3 (Camp Suisse). The invoice-number dialog was changed for this invoice only ('Set as default' left off), so the next Revolut number is still 2026-4. PDF invoice_2026-2.pdf in Downloads; **SENT by the owner 16 Sept 23:14**, his own wording, from partnerships@, with invoice_2026-2.pdf attached. The owner was writing this mail himself; my replacement draft and the retitling of his draft were an interference (owner correction, LESSONS_LEARNED 16 Sept) and did not reach the sent mail. My replacement draft is now retitled [SUPERSEDED, DISCARD] and detached from the thread. For the record: the mail body names 2026-002 while the attached invoice is 2026-2, and compta@ was not copied; owner's call whether either needs a word. **Owner decision:** a short separate mail to compta@leselfes.com with the same invoice, referencing Alexandra's confirmation of 8 Sept; draft created 16 Sept (new thread, no attachment: owner attaches invoice_2026-2.pdf, switches From to partnerships@, closes the space). The unshared standalone payment link 'Invoice 2026-002' can wait: nobody holds its URL. **Compta mail SENT by the owner 16 Sept.**

**Danish operators in Danish (owner rule 16 Sept):** the four Danish outreach drafts (SceneKunst, Din Camp, Nordisk Sommerlejr for børn, Ranum Efterskole) were English; rewritten in Danish as new drafts (sender sorenthoning@ until the owner switches to partnerships@; close the space). English versions of Din Camp, Nordisk and Ranum retitled [SUPERSEDED, DISCARD]; the English SceneKunst draft was open in the owner's hands and is left for him to discard. Danish template and choices recorded in docs/drafts/2026-09-15-outreach-template-OF-RECORD.md. **Owner decisions 16 Sept, 23:35:** keep EUR for Danish operators; Norwegian and Swedish operators stay in English. (The old PDF 2026-002 is filed as never delivered and superseded. The unshared standalone payment link 'Invoice 2026-002' from 12 Sept still exists under Merchant, Payment links: owner to deactivate it when convenient, not urgent.)

**RESOLVED 16 Sept (see above: reissued as Revolut 2026-2 and sent). History:** Les Elfes invoice 2026-002 was probably never attached. The mail of 10 Sept 22:46 UTC to Alexandra (cc compta@) says "The invoice for the 2027 season is attached", but its attachment list holds only six images from the quoted signature, and no sent mail to either Les Elfes address matches a PDF. The final PDF exists (bridge reference folder, ESC-Invoice-2026-002-Les-Elfes.pdf, issued 10 Sept, due 24 Sept). Owner to confirm in Gmail's Sent folder, then decide how to send it (a short apology line and the PDF, or a Revolut invoice); the 24 Sept due date cannot stand if it was never received.

**Jordan reply, third version (owner review):** rebuilt on the template of record and the La Garenne mail: thanks him for reaching out, explains that we added the Oxford programme ourselves and kept it free and current, 22 families since March alone, why the arrangement is changing ("due to this"), fee and Premium in one place, nothing owed for 2026, European scope with Cambridge and Harrow, the key question on its own line, "no obligation". Two deliberate departures, for the owner: the launch claim "early 2025, over 2 seasons ago" is left out (our first commit is 23 Aug 2025 and this is a large operator), and the removal offer is left out because he approached us. Second version retitled SUPERSEDED.

**Receipts gathered** into a private folder outside the repo (OneDrive Documents, "ResourceHub receipts 2026"): Anthropic invoice and receipt, OpenAI invoice (USD 18 plus 25 percent Danish VAT), the August Revolut plan-fee statement, an expense list and a README; sales invoices 2026-001, 2026-002 and 2026-3 in a subfolder. Added the same evening on the owner's confirmation (all AI review work is business): OpenAI invoices of 6 Sept (USD 17.50) and 10 Sept (USD 6.25), both paid from a private card, so owner's outlays; their DKK amounts still to be read from the card statement. Still missing: the Revolut 2026 account statement covering the April to July plan fees (the dialog is set to Year 2026, PDF; Chrome is blocking further automatic downloads from business.revolut.com, owner to allow or press Generate) and the OpenAI payment receipts (the invoices suffice). Revolut statements carry bank details: never copy them into the repo.
...
**COUNCIL CLOSED 13 Sept 2026, 16:10.** Round two (lead, Fable SEO seat, Fable engineering seat, Astra, Gemini; every seat read the plan, the round-one record and the competitor report) and a rebuttal round are recorded in `docs/reports/PHASE_2_COUNCIL_2026-09-13.md` sections 6.2 to 6.5, every finding adjudicated, thinking tokens and durations per seat. **Decision (6.5):** an evidence-gated static publishing wave on a post-build generator beside the untouched app. Batch 1a target 22 Sept: a how-we-verify page (no camp facts, proves the pipeline, its indexing time is the first measurement). Batch 1b target 26 Sept: a winter-camps-in-Europe page from the ten verified winter records. Batch two target 5 Oct: Norway, Denmark, Sweden and a Nordic regional page carrying Finland. Batch three target 20 Oct: Switzerland (a price-transparency page, no camp-count claim), Spain, France, UK, Germany, Italy, each gated on Wave 2 date re-checks, four verified operators, and a fact class the ranking pages lack. Wave two in November: English-learning page (needs programme fields first), cost comparison, Central and Eastern Europe, partner pages if decided 5 Oct. Homepage untouched; the prerender question is closed (Googlebot renders the grid, record 6.7). Per-camp pages: none automatic; Les Elfes and ILC pages as a paid feature, decided 5 Oct. Guardrails: no digit in prose, every figure interpolated and validated byte-equal, keyed evidence packets per offer, contentValidUntil per page with omit-and-stub on expiry and a weekly scheduled rebuild, outbound.js extraction tested on all 78 rows, external consent and GA4 script (CSP), trailingSlash false in its own commit between batches, withdrawn pages become noindex stubs. Upside: no assumed minimum (Astra's late rebuttal, section 6.6, retired every "floor"; scenarios are sensitivity cases; the keyword pull tests whether 8,000 monthly impressions are even reachable). Abort rule: technical or consent regressions stop deployment; head-query deterioration pauses expansion and triggers diagnosis. Trigger: how-we-verify not indexed within ten days reorders batch two to Switzerland and Spain. **Owner actions:** (a) create a Vercel deploy hook (project Settings > Git > Deploy Hooks, branch main) and store its URL as the GitHub Actions secret VERCEL_DEPLOY_HOOK_URL; the workflow .github/workflows/weekly-rebuild.yml is committed and does nothing until then; (b) OpenAI topped up by the owner on 13 Sept evening, Astra rebuttal received and adjudicated (6.6); (c) DONE 13 Sept 22:50: the owner dropped the "view crawled page" HTML in the bridge; Googlebot renders the full grid (68 cards, prices, badges), so the homepage prerender question is closed and no release edits the root (council record 6.7). **Pre-pilot tasks before 22 Sept:** keyword volumes and Bing Webmaster country-query impressions (else NOT FOUND and unbudgeted), GA4 landing-page baseline, fixed head-query set by device and country, production homepage count reads 68.

**SESSION EXIT 14 Sept 03:10.** Everything committed. **Next session, two tracks in parallel:** (A) start the Wave 2 re-verification immediately (plan section 19: Nordic camps first, read-only agents four at a time, the lead re-reads every figure, `verifiedOn` updated per row) because verified 2027 facts are the critical path for the country pages and finishing early moves 5 and 20 October forward; (B) continue the build in plan order: trailingSlash plus 404 (needs a branch push for the preview), the generator, the validator, the booking anchor. The plan now carries the reasoning in section 18 (why this beats the 2025 plan, why the calendar is gated on operator publication rather than build time, why no page per camp) and the index-page decision in section 17. Council verdict page explains all of it visually: `docs/reports/phase2-council-verdict-2026-09-13.html`.

**Earlier exit note 02:45.** Everything committed; the council verdict page explains the implementation plan too (why a generator, the fourteen-step order with status, what review caught); hooks point at auto-memory `esc-session-2026-09-14-handoff`. **Resume by reading that memory, then section 16 of the plan, then build in this order: trailingSlash plus 404 (needs a branch push for the preview), the generator, the validator, the booking anchor.**

**STEP 0b DONE 14 Sept 02:15:** `verifiedOn` ISO field on all 79 camp rows (from each row's latest dated provenance comment; ten rows without one took their documented verification history), enforced in `validate-camps.js`, build and lint green (commit 2d72cea). The static pages print this date. **Next, per section 16 of the plan:** the `trailingSlash: false` plus `public/404.html` commit (preview curl matrix; the owner must push a branch for any preview test), then the generator with the manifest-based asset loader, then `validate-static.js` against three fixtures and three mutations, then the booking anchor on all three controls with a 79-row fixture.

**DONE 14 Sept 02:00: the implementation plan is written and reviewed by three seats (engineering agent, SEO agent briefed on the AI-search record, Astra), 35 findings adjudicated, final decisions in section 16 of `docs/plans/2026-09-14-static-wave-implementation-plan.md`; next is step 0b (verifiedOn field) and the trailingSlash commit, then the generator.** Original note: write the critically reviewed implementation plan for the council decision** (`docs/plans/2026-09-14-static-wave-implementation-plan.md`: generator, templates, validators, outbound extraction, link control, IndexNow, expiry, batch 1a to 3 with tests and rollback; reviewed by three seats: a read-only engineering agent, a top-class SEO review by the seo-performance-optimizer agent briefed to read the AI-search research record and seat reports first so it is fully up to speed on AI search in 2026, and Astra; every finding adjudicated) before any building. No such plan exists yet; only the decision record does. The council verdict page now says llms.txt is skipped (updated 23:50).

**AI-search research DONE 13 Sept 2026, 23:30 (owner: "the internet where the personal AI moves, not the user").** Record: `docs/reports/AI_SEARCH_RESEARCH_2026-09-13.md` (six seats adjudicated: three Fable agents, Astra with web search, Gemini, Grok with X search; seat reports under `docs/reports/ai-search-seats/`). Baseline from GA4 (`scripts/ga4-ai-referrers.py`, new): 2026 to date google 1,423 sessions / 880 booking clicks, chatgpt.com 406 / 312, bing 117 / 97; nothing yet from Gemini, Copilot, Perplexity or Claude. **Held up against the council plan: the static wave is confirmed as the right response; amendments in sections 8 and 12:** provenance line per row in the page text; answer block first, then 100 to 180-word sections under question headings; one page one question; IndexNow on release; how-we-verify names reviewer, method, limits, corrections, paid-listing disclosure; the booking control becomes a real link with the tracked URL (ships with the outbound extraction, tested); llms.txt, extra schema, chunking, Reddit seeding, MCP, ReserveAction and homepage prerendering are wastes. **Owner, 20 minutes:** Search Console > Settings > Search generative AI reads Include (default); open the new Generative AI performance report and Bing Webmaster Tools > AI Performance once and screenshot September; glance at Vercel Firewall to confirm the managed AI-bots ruleset is inactive. **Council verdict page:** its AI section still lists llms.txt as a cheap move; downgrade it next session.

**Outreach 13 Sept, 22:40:** the owner's third round of edits (Camp Adventure) applied to all 52 remaining drafts and verified; EUROCAMP opens "Dear Mrs Martincová"; Camp California and Camp Adventure sent by the owner from partnerships@; the 14 SUPERSEDED drafts are gone. Owner question pending: can Claude in Chrome switch the sender to partnerships@ in the Gmail composer? Answer given: yes in principle (the From dropdown is in the web composer), untested; try on one draft with the owner watching before any batch.

**Winter section, competitor standard, 13 Sept 2026, 16:50 (owner decision: build now).** Competitor check done on their own pages (World Camps' winter and ski pages still "2026 dates coming soon", their 18 European winter camps mostly UK language courses; Swiss-Camps.org lists four without dates or prices; Ski-camp.ch is friLingue's own marketing site at 2025 prices): nobody shows 2026-27 dates with a sourced per-child price. Eleventh winter row published: friLingue St. Bernard Ski & Snowboard Camp, Liddes (ID 83, CHF 1,300 a week, 20 Dec 2026 to 6 Mar 2027, dates and price now on the operator's page). Inclusions re-read and added to the FILOLO and AR-Sport cards (hire CHF 150 and PLN 280 a week). Still held: friLingue Braunwald (page reads 2028), Lovell (reachable again, 2026-27 rates "Coming Soon", recheck October). New candidates: St. George's International School winter camp (Villars), Institut Monte Rosa (Montreux), SILC Gstaad Winter Leadership. **Owner:** Les Elfes' page lists equipment rental and the Geneva transfer as extras; her Premium card does not say so (six highlights already), decide whether to ask her or leave it. The nine operator question drafts for winter are still in Gmail. Record: WINTER_VETTING gate section dated 13 Sept 16:45. Next camp ID: 84.

**Owner decisions 13 Sept 2026, evening:** (2) winter section BUILD NOW to the competitor standard (exact 2026 to 2027 dates, total per-child cost with equipment and lift pass, teaching language, minimum age; check Ski-camp.ch, Swiss-Camps.org and World Camps' 18 first); it is owed to Les Elfes. (3) Altitude (ID 4) moved to Language Immersion with both products priced on the card (done, this commit). (4) EUR 79 fee timing kept; prices stay 79 / 199 / 299 for the outreach (competitor benchmark: World Camps USD 990 and 1,590 per profile, free tier without a direct link). **Capacity correction (owner):** AI capacity is ample; the gates are verification, ranking risk and the season calendar, never engineer hours. **Round two of the Phase 2 council is GREEN-LIT and running:** five seats (lead revised position first; Fable SEO agent; Fable engineering agent on the isolated static layer; Astra; Gemini), every seat gets the plan, the round-one record and the competitor report, must answer three objections to its own view, then a rebuttal round; thinking tokens and durations recorded per seat. Files: scratchpad `council/round2-brief.md`, outputs `council/round2.*.md`; record goes into `docs/reports/PHASE_2_COUNCIL_2026-09-13.md` section 6. If the session resets mid-round, resume from those files.

**Phase 2 council held 13 Sept 2026 (lead + GPT-6 Astra + Gemini 3.8 Flash, identical brief with all ranking and traffic data and the full plan): unanimous, do NOT execute the 2025 plan.** Record: `docs/reports/PHASE_2_COUNCIL_2026-09-13.md` (evidence, the lead's independent analysis, both external seats, every finding adjudicated, decision record). Consensus: an isolated static publishing layer beside the app (a Switzerland page and, if verified fields allow, an English-learning comparison page), homepage byte-identical, no router around the monolith, no duplicate discovery URL, no per-camp pages before the season is over, the 1,000-session gate retired in favour of content, deployment, attribution and capacity gates, success measured as incremental referral sessions sitewide. Earliest pilot release late September or October, after the outreach and Wave 2 load. Superseded by round two and the rebuttal round; see the 16:10 block above and section 6.5 of the record. Before it: baseline (fixed head queries by device and country), Search Console URL Inspection of the homepage, Bing Webmaster country impressions, keyword volumes.

**Top-three card check 13 Sept 2026 (camp-data-verifier, key figures re-read by the lead):** EUROCAMP (ID 9) dates moved to the six published 2027 terms, badge "2027 dates published", activities rewritten from the operator site (no caves exist there), established 2006 (the camp, not the organiser). Adventure Camp Bavaria (ID 10): price EUR 395 (lowest summer 2027 week on the booking form, was 435), badge "open" (weeks selectable with prices), activities and highlights rewritten from the operator site (river campsite in tents or cabins, English and German programme; the card had invented a mountain lake, German traditions, castles and folk culture). **Owner decisions:** Altitude (ID 4) sits in Budget Excellence at about EUR 1,045 a week (day-camp price, residential CHF 2,950) and its "3-14 years" span mixes the day-camp and residential products; category and a price wording fix are judgement calls. All three cards show ratings and review counts with no reviewData provenance (4.8/267, 4.6/189, 4.8/234), the Phase 2 review-aggregation debt. Transport add-ons, deposits and tent accommodation are not on any card.

**Competitor analysis DONE 13 Sept 2026:** `docs/reports/COMPETITOR_ANALYSIS_2026-09-13.md` (SEO agent plus Astra web research, lead-verified on the competitors' pages, every move adjudicated). World Camps is the competitor: 206 European camps, 19 country pages, USD 990 and 1,590 a year per camp profile, but prices in dollars, "2026 dates coming soon" in mid-September, three European ski camps, 18 winter camps in Europe. Winter section gate now includes a competitor check (Ski-camp.ch, Swiss-Camps.org) and the content standard (exact 2026 to 2027 dates, total per-child cost, teaching language, minimum age). Pilot candidates: Switzerland page and a public verification-methodology page. Check on production that the homepage count reads 68 (Astra saw 67 in a fetch).

**EUROCAM Bohemia (ID 9) operator check CLOSED 13 Sept 2026: KEEP, all five criteria met.** Checked by the lead (euro-camp.eu, anglickytabor.cz, syka.cz, ARES register IČO 28499883) and independently by camp-data-verifier; both reached the same verdict. "Cestovní kancelář" is the statutory licence that Czech Act 159/1999 requires of every children's camp organiser ("zákon č. 159/1999 Sb., který ukládá pořadatelům dětských táborů povinnost stát se cestovní kanceláří. Proto vznikla SYKA AGENCY a.s."); the company sells only its own three English camps at "dvou vlastních rekreačních střediscích" (two of its own recreation centres) near Stádlec, own TEFL leaders, own kitchen; EUR 335 is camp-only with the Prague bus optional at EUR 15 each way. The fee request draft can go. **2027 already published on the SYKA calendar (syka.cz/en/calendar.php):** six EUROCAMP terms 2-11 Jul, 11-20 Jul, 20-29 Jul, 1-10 Aug, 10-19 Aug, 19-28 Aug 2027; price not yet shown (the form still says 2026). The draft's data line now says we have seen the calendar and asks for the price. Card items for Wave 2 when the reply comes: the operator brands it "EUROCAMP" (one word, no "Bohemia"); `established: 1995` is the organiser's first camp (SUMMER TIME), EUROCAMP itself dates from 2006; `capacity: 120` not found on any page; location could read "Stádlec, South Bohemia". None of these blocks the mail.

**Referral figures re-checked in GA4 on 13 Sept (owner asked whether Enforex is a top camp):** EUROCAM 87, Adventure Camp Bavaria 80, Altitude 59, Les Elfes 55, Enforex 35 + 19 = 54 (fifth; its draft claims no rank), Village Camps 19 + 8 = 27. The three rank claims in the drafts are correct. The figures are booking-click events; distinct users run lower (Evasoleil 34 clicks from 15 users). **Owner decision 13 Sept: keep the click count and the "families" wording**, no change to any draft. The ga4 connector timed out at session start because analytics-mcp takes 25 to 28 s to answer initialize against a 30 s limit (not TLS); `scripts/ga4-pull.py` did the pull; bridge note to Playground proposes `MCP_TIMEOUT=90000`.
...
3. **First contact:** no link, no invoice. The payment sentence in the template and in all 57 outreach drafts reads, since 12 Sept 22:45 (owner: a bare "link" can feel risky, the invoice must come first): "Your invoice for the 2027 season follows as soon as we have your details. It is a standard invoice, payable by bank transfer, and it also offers a secure online card payment should you prefer that; either way there is nothing to set up on your side. The next invoice date after that is 1 September 2027." Verified on the full draft listing afterwards: 57 outreach drafts carry it exactly once, no old wording left, no URL, no em dash, recipients and subjects unchanged. 56 standalone drafts were updated in place; the Funside reply in Réka's thread was replaced by a new threaded draft.
5. **ILC and Les Elfes replies shortened (owner, 12 Sept):** the two live reply drafts (ILC in Elodie's thread, Les Elfes in Alexandra's thread) now say only that the card is updated as they asked and that we value the partnership, five or six lines each. The ILC draft names "the boutique Hotel Au Vieux Moulin", so **push commit 5a7bb1f before sending it**. The long versions were retitled [SUPERSEDED, DISCARD]. The owner now has **13** drafts titled [SUPERSEDED, DISCARD] to discard.
4. **DONE 12 Sept 22:15:** test invoice 2026-1 cancelled (status Cancelled, no payment possible). Two payment links created under Merchant, Payment links, both Active, single use, EUR 199: "Invoice 2026-001 (International Summer Camps, Premium listing)" and "Invoice 2026-002 (Les Elfes International, Premium listing)". Nothing shared; the owner copies the link from the app ("Copy link") into the reminder mail if and when it is needed. The link URLs are not stored in the repo.
...
3. Wave 2 as replies arrive: Camp California, Explorer 845, Kalkalpen 2027, Vierumaki, EUROCAM 2027 price and card details (operator check closed 13 Sept), Warsaw Montessori, Atlas.
