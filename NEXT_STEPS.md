...
**Danish operators in Danish (owner rule 16 Sept):** the four Danish outreach drafts (SceneKunst, Din Camp, Nordisk Sommerlejr for børn, Ranum Efterskole) were English; rewritten in Danish as new drafts (sender sorenthoning@ until the owner switches to partnerships@; close the space). English versions of Din Camp, Nordisk and Ranum retitled [SUPERSEDED, DISCARD]; the English SceneKunst draft was open in the owner's hands and is left for him to discard. Danish template and choices recorded in docs/drafts/2026-09-15-outreach-template-OF-RECORD.md. Owner questions: DKK instead of EUR for Danish operators? Norwegian and Swedish operators (10 rows) still get English. The old PDF 2026-002 is filed as never delivered and superseded. The unshared standalone payment link 'Invoice 2026-002' from 12 Sept still exists under Merchant, Payment links: owner to deactivate it so only the invoice's own link can take the payment.

**🔴 Les Elfes invoice 2026-002 was probably never attached.** The mail of 10 Sept 22:46 UTC to Alexandra (cc compta@) says "The invoice for the 2027 season is attached", but its attachment list holds only six images from the quoted signature, and no sent mail to either Les Elfes address matches a PDF. The final PDF exists (bridge reference folder, ESC-Invoice-2026-002-Les-Elfes.pdf, issued 10 Sept, due 24 Sept). Owner to confirm in Gmail's Sent folder, then decide how to send it (a short apology line and the PDF, or a Revolut invoice); the 24 Sept due date cannot stand if it was never received.
