...
**Receipts gathered** into a private folder outside the repo (OneDrive Documents, "ResourceHub receipts 2026"): Anthropic invoice and receipt, OpenAI invoice (USD 18 plus 25 percent Danish VAT), the August Revolut plan-fee statement, an expense list and a README; sales invoices 2026-001, 2026-002 and 2026-3 in a subfolder. Still missing: Revolut plan-fee statements for April to July (Chrome held back the extra downloads in a background window) and the OpenAI payment receipt. Revolut statements carry bank details: never copy them into the repo.
