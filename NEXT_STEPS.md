...
**SESSION LIMIT 13 Sept 2026 (lifts 15:40): council round two was running with four seats; the lead's position is section 6.1 of the council record; resume per auto-memory `esc-session-2026-09-13-handoff` (outputs in the scratchpad council folder, then section 6.2, rebuttal round, decision, then the winter build).**
