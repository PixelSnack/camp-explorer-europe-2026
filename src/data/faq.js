...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Every camp in this directory has passed our five-point verification (a real residential camp, run by a camp operator, with per-child pricing, on-site programs and an operator-run facility) plus a manual check of its website, contact details, business registration and pricing. When researching any camp yourself, check the website, look for memberships and accreditations, read reviews from more than one source, and ask the camp directly about insurance and safety protocols. Established camps have clear contact information and transparent policies. Prices and programs change, so confirm the details with the camp before booking."
  },
  {
