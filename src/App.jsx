...
function App() {
  ...
  const allCamps = [
    ...
    // Budget Excellence Expansion - Austria
    {
      ...
      dates: "Multiple 2-week sessions, Summer 2026",
    ...
    // Outdoor Adventures Expansion - Portugal
    {
      ...
      dates: "June 29-July 12 & July 13-26, 2026",
      highlights: ["50+ years camp experience (since 1972)", "Atlantic coast location", "Modern exclusive residence", "World-class surf waves"],
      languages: ["English"],
      specialFeatures: ["Education Through Recreation™ philosophy", "International camp environment", "Recently constructed residence"],
      established: 1972,
      capacity: 80,
