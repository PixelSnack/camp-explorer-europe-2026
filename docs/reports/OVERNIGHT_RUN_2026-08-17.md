...
**Pointer added 4 Sept 2026:** this 17 Aug run is closed. The live state for the 3 to 4 Sept season-rollover session is `docs/reports/WAVE1_ROLLOVER_PLAN_2026-09-03.md` (implementation record and addendum) plus the NEXT_STEPS pickup block; nothing is in flight there either.
