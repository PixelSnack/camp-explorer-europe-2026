...
## Production gates after the push (4 September 2026, ~19:40)

Owner pushed all commits through 10ed969 at about 19:00. Live HTML fetched with a cache-buster: title `European Summer Camps 2027 | 100+ Camp Programs | Camp Explorer Europe`, description with "EUR 130 per week", og:title matching, noscript H1 `European Summer Camps | Camp Explorer Europe`, bundle hash identical to the local build, FAQPage block present, zero stale strings (the one regex hit is EUROCAM Bohemia's genuine EUR 335 price). Headers live: HSTS, X-Frame-Options DENY, CSP report-only.
