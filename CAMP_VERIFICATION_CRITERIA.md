# CAMP VERIFICATION CRITERIA & STANDARDS
...
3. **Camp-only per-child pricing**: one child's place, transport to the resort excluded or shown separately, with what the price includes stated. A price that exists only with coach travel included fails unless a price without transport is published. **Owner decision 16 Sept 2026 (Camp Suisse Ski Camp):** an accompanied airport or station transfer inside the camp fee is NOT transport in the price; it passes, and the card says the transfer is included. Coach travel from a home city stays under the rule above.
